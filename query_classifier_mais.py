...
class QueryClassifier:
    ...
    def classify_and_extract(self, query):
        ...
        Pergunta: "Qual a dose recomendada de Iberzoon para bovinos?"
        {{"categoria": "medicamento", "entidades": {{"termo_busca": "Iberzoon bovinos", "pergunta_ollama": "Informações sobre a dose recomendada de Iberzoon para bovinos"}}}}
